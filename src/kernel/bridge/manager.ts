...
import init from '../../engine/pkg/wasm_rust.js';
...
const WASM_METHODS = [
  ...
  { name: 'wasm_get_app_state', description: 'Retrieves the global app state from WASM.' },
  { name: 'wasm_update_app_state', description: 'Updates the global app state in WASM.' },
] as const;

/**
 * Retrieves a list of functions exposed by the WASM module through the bridge.
 * @returns An array of objects containing function names and descriptions.
 */
 ...
 * This includes mapping TypeScript calls to specific WASM exports.
