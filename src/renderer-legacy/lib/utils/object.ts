...
export function get<T extends object, K extends keyof T>(obj: T, key: K): T[K] | undefined;
export function get<T extends object, K extends keyof T>(obj: T, key: K, fallback: T[K]): T[K];
export function get<T extends object, K extends keyof T>(obj: T, key: K, fallback?: T[K]): T[K] | undefined {
