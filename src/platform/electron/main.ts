...
function getSqlitePath() {
  ...
  if (isPackaged) {
    ...
    return path.join(appPath.replace('app.asar', 'app.asar.unpacked'), 'src/platform/native/sqlite/index.js');
  }
  // In development
  return path.join(appPath, 'src/platform/native/sqlite/index.js');
}
