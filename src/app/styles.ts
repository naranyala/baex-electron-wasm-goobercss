...
/**
 * Foundational design tokens (colors, spacing, etc.) for the EXBA framework.
 */
export const t = {
  zinc50: '#fafafa',
  zinc100: '#f4f4f5',
...
/**
 * CSS variable mappings for theme-aware components.
 */
export const theme = {
...
/** Default transition timing for UI interactions. */
...
/**
 * Exported collection of global CSS classes powered by Goober.
 */
export const styles = {
  appBody,
  appContainer,
